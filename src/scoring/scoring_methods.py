...
class ScoringDeckPd:
    ...
    def score_save_all_combos(self):
        """
        This method cycles through all possible choices for the players, 
        calling ._score_deck() to score each time, which returns a dicitonary of wins.
        It then adds each of these dictionaries to a dataframe,
        and returns a dataframe of each player choice combo and who won with this deck.
        """
...
def score_file(file_path:str):
    ...
    It then continuously adds the player win combinations to the current 
    records stored in "player_wins.csv" and saves over a new version.
    """
